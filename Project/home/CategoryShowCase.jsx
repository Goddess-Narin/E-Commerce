        ...
        <div className='section-header'>
          ...
          <div className='course-filter-group'>
            <ul className='lab-ul'>
              ...
              <li onClick={() => fitlerItem("Shoes")}>Shoes</li>
              <li onClick={() => fitlerItem("Bags")}>Bags</li>
              <li onClick={() => fitlerItem("Phones")}>Phones</li>
              <li onClick={() => fitlerItem("Beauty")}>Beauty</li>
            </ul>
          </div>
        </div>
        {/* Section Body */}
        <div className= 'section-wrapper'>
          <div className='row g-4 justify-content row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols'>
            {
